...
const ViewAuctionDetails = () => {
  ...
  return (
    <section className="page-content relative">
      <div className="orb" style={{ width: "300px", height: "300px", top: "-50px", right: "-80px", background: "rgba(214,72,43,0.10)" }} />
      <div className="orb" style={{ width: "220px", height: "220px", bottom: "20px", left: "-60px", background: "rgba(201,168,76,0.10)", animationDelay: "-4s" }} />

      <div className="relative z-10 mb-6 flex flex-wrap items-center gap-2 text-[16px] text-[var(--muted)]">
        <Link to="/" className="font-semibold transition-all duration-300 hover:text-[var(--gold)]">Home</Link>
        <FaGreaterThan className="text-[var(--muted)]" />
        <Link to="/view-my-auctions" className="font-semibold transition-all duration-300 hover:text-[var(--gold)]">My Auctions</Link>
        <FaGreaterThan className="text-[var(--muted)]" />
            ...
            <div className="flex gap-4 flex-col lg:flex-row lg:items-stretch">
              ...
              <div className="flex flex-1 flex-col justify-between gap-4">
                ...
                <div className="rounded-2xl border border-[var(--border)] bg-[rgba(201,168,76,0.06)] p-4 text-sm text-[var(--muted)]">
                  High quality images are shown when available.
                </div>
              </div>
            </div>
